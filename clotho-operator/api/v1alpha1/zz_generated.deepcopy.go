...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MessageBusSpec) DeepCopyInto(out *MessageBusSpec) {
	*out = *in
	if in.Config != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MessageBusSpec.
func (in *MessageBusSpec) DeepCopy() *MessageBusSpec {
	if in == nil {
		return nil
	}
	out := new(MessageBusSpec)
	in.DeepCopyInto(out)
	return out
}
