...
func init() {
	...
	// Register Clotho Types
	utilruntime.Must(clothov1alpha1.AddToScheme(scheme))

	// --- ADD THIS LINE ---
	// Register SpinKube Types (This fixes your error)
	utilruntime.Must(spinva1.AddToScheme(scheme))
}
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "84609284.clotho.run",
